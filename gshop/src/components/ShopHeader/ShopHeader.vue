<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="support=!support">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="support" v-if="info.supports">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close" @click="support=!support">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
